...
import { idlFactory } from './topup.did.js';
export { idlFactory } from './topup.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOPUP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./topup.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the topup canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./topup.did.js")._SERVICE>}
 */
export const topup = createActor(canisterId);
