...
export const canisterId = process.env.MULTISIG_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./multisig.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the multisig canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./multisig.did.js")._SERVICE>}
 */
