...
export const canisterId = process.env.SWAP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./swap.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the swap canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./swap.did.js")._SERVICE>}
 */
export const swap = createActor(canisterId);
